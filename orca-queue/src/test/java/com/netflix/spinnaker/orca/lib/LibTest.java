...
package com.netflix.spinnaker.orca.lib;
...
public class LibTest {
  ...
  @Test
  public void repositoryShouldGetAutowired() {
    ...
    ExecutionLatchKt.runToCompletion(context, pipeline, (p) -> {
      runner.start(p);
...
class TestConfig {
  ...
  Registry registry() {
    ...
    when(registryMock.createId(anyString())).thenReturn(mock(Id.class));
    when(registryMock.counter(any(Id.class))).thenReturn(mock(Counter.class));
